...
public extension CALayer {
    ...
    /// 设置默认阴影效果
    func setDefaultShadow(alpha: CGFloat = 0.02) {
        self.shadowColor   = UIColor.black0.withAlphaComponent(alpha).cgColor
        self.shadowOffset  = CGSize(width: AdaptSize(1), height: AdaptSize(1))
