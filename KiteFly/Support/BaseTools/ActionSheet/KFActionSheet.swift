...
open class KFActionSheet: KFTopWindowView {
    ...
    public func addItem(icon: UIImage? = nil, title: String, isDestroy: Bool = false, actionBlock: DefaultBlock?) -> KFActionSheet {
        let button = KFButton(.normal)
    ...
    @objc public func clickAction(sender: KFButton) {
