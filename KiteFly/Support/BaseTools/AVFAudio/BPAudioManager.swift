...
public protocol BPAudioManagerDelegate: NSObjectProtocol {
    /// 每0.1s刷新一次
...
/// 声音管理器
@objc(BPAudioManager)
open class BPAudioManager: NSObject, AVAudioRecorderDelegate {

    @objc
    static public let share = BPAudioManager()
    @objc
    public weak var delegate: BPAudioManagerDelegate?

    private let filePath = BPFileManager.share.voicePath + "/voice.aac"
