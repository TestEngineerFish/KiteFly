...
protocol KFSystemAlbumListViewDelegate: NSObjectProtocol {
...
class KFSystemAlbumListView: TYView_ty, UITableViewDelegate, UITableViewDataSource {
    ...
    private var currentModel: KFPhotoAlbumModel? {
        didSet {
    ...
    weak var delegate: KFSystemAlbumListViewDelegate?
    ...
    override func bindProperty() {
        ...
        self.tableView.register(KFSystemAlbumCell.classForCoder(), forCellReuseIdentifier: cellID)
    ...
    func setData(albumList: [KFPhotoAlbumModel], current model: KFPhotoAlbumModel?) {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: cellID, for: indexPath) as? KFSystemAlbumCell else {
