...
public protocol KFPhotoAlbumViewControllerDelegate: KFPhotoAlbumToolsDelegate {}

/// 方格显示传递过来的资源
public class KFPhotoAlbumViewController:
    KFViewController,
    UICollectionViewDelegate,
    UICollectionViewDataSource,
    KFPhotoAlbumToolsDelegate,
    KFPhotoAlbumCellDelegate {
    
    public weak var delegate: KFPhotoAlbumViewControllerDelegate?
    ...
    private var toolsView = KFPhotoAlbumToolsView()
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: kBPPhotoAlbumCellID, for: indexPath) as? KFMediaCell else {
    ...
    public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        KFBrowserView(type: .custom(modelList: modelList), current: indexPath.row).show(animationView: cell.imageView)
    }
