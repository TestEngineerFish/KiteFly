...
protocol KFPhotoAlbumCellDelegate: NSObjectProtocol {
...
class KFMediaCell: KFCollectionViewCell {
    /// 历史照片列表使用
    ...
    private var selectButton: KFButton = {
        let button = KFButton()
...
//            }
    ...
    @objc private func selectedImage(sender: KFButton) {
