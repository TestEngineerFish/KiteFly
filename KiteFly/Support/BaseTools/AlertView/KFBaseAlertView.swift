...
open class KFBaseAlertView: KFTopWindowView {
    ...
    /// 背景图
    internal var backgroundImage: KFImageView = {
    ...
    /// 左边按钮
    open var leftButton: KFButton = {
        let button = KFButton(.normal, size: CGSize(width: AdaptSize(100), height: AdaptSize(35)))
    ...
    /// 右边按钮
    open var rightButton: KFButton = {
        let button = KFButton(.theme, size: CGSize(width: AdaptSize(100), height: AdaptSize(35)), animation: false)
